        ...
        <article class="fade-in landing-hero">
            <div class="hero-content">
                ...
                <p class="hero-subheadline animate-rise-in delay-150">
                    Propose times, let participants enter schedule conflicts, and view the remaining gaps. No accounts required.  <a href="#" id="open-philosophy-link" class="philosophy-trigger">Learn more</a>
                </p>
